...
# ENABLE_REG is a CLI flag — not stored in .env — keep the value from args
# (sourcing .env above won't overwrite it since .env doesn't have ENABLE_REG)
...
# Logging — path generated by 'docker run ... generate' bootstrap
# If this file doesn't exist yet, Synapse generate will create it.
...
# Logging — .log.config was just created by the generate step above
log_config: "/data/${SERVER_NAME}.log.config"
